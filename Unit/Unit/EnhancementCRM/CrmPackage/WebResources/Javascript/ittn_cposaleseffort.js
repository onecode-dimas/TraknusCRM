...
function User_IsApprover() {
    ...
    var path = "/ittn_approvallistcposaleseffortSet?$select=ittn_approvallistcposaleseffortId&$filter=ittn_CPOSalesEffort/Id eq (guid'" + recordid + "') and ittn_Approver/Id eq (guid'" + userid + "')";
    ...
    if (retrieveReq.readyState == 4 /* complete */) {
        ...
        if (retrieved != null && retrieved.results.length > 0) {
            ...
            Xrm.Page.getControl("ittn_approvesaleseffort").setVisible(true);
        }
        else
        {
            Xrm.Page.getControl("ittn_approvesaleseffort").setVisible(false);
        }
    }
