...
{
    public class MWSLogWebService
    {
        #region Constants
        private const string _classname = "MWSLogWebService";
        #endregion
        ...
        private string LogTable = "LogTableName"; //Table Name : Log_SAP_Unit
        public enum LogType
        {
            Error,
            Information
