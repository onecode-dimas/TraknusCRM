...
{
    public class DL_activitypointer
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_activitypointer";

        private string _entityname = "activitypointer";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Activity Pointer";
