...
{
    public class DL_trs_mechanicgrade
    {
        #region Properties
        private string _classname = "DL_trs_mechanicgrade";

        private string _entityname = "trs_mechanicgrade";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Mechanic Grade";
