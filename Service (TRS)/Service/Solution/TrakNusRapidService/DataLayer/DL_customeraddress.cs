...
{
    public class DL_customeraddress
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_customeraddress";

        private string _entityname = "customeraddress";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Customer Address";
