...
{
    public class DL_trs_tasklistgroup
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_trs_tasklistgroup";

        private string _entityname = "trs_tasklistgroup";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Task List Group";
