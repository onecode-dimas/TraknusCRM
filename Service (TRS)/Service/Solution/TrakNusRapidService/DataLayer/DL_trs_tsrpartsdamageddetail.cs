...
{
    public class DL_trs_tsrpartsdamageddetail
    {
        #region Dependencies
        ...
        #region Properties
        private string _classname = "DL_trs_tsrpartsdamageddetail";

        private string _entityname = "trs_tsrpartsdamageddetail";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "TRS - Part Damaged";
