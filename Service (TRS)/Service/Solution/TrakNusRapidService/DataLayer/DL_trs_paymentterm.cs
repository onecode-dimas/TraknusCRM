...
{
    public class DL_trs_paymentterm
    {
        #region Dependencies
        #endregion
        #region Properties
        private string _classname = "DL_trs_paymentterm";

        private string _entityname = "trs_paymentterm";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Payment Term";
