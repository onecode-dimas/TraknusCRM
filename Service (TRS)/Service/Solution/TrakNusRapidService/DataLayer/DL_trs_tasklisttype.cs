...
{
    public class DL_trs_tasklisttype
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_trs_tasklisttype";

        private string _entityname = "trs_tasklisttype";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Task List Type";
