...
{
    public class DL_trs_quotationsupportingmaterial
    {
        #region Dependencies
        ...
        #region Properties
        private string _classname = "DL_trs_quotationsupportingmaterial";

        private string _entityname = "trs_quotationsupportingmaterial";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Quotation Supporting Material";
