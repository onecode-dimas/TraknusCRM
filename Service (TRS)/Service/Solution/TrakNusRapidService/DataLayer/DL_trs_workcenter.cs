...
{
    public class DL_trs_workcenter
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_trs_workcenter";

        private string _entityname = "trs_workcenter";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Work Center";
