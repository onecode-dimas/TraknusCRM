...
{
    public class DL_contractdetail
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_contractdetail";

        private string _entityname = "contractdetail";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Contract Detail";
