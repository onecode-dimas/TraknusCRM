...
{
    public class DL_trs_technicalservicereportdocumentation
    {
        #region Dependencies
        ...
        #region Properties
        private string _classname = "DL_trs_technicalservicereportdocumentation";

        private string _entityname = "trs_technicalservicereportdocumentation";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "TSR (Documentation)";
        public string DisplayName
        {
            get { return _displayname; }
        }

        private bool _trs_technicalservicereportid = false;
        private EntityReference _trs_technicalservicereportid_value;
        public Guid trs_technicalservicereportid
        {
            get { return _trs_technicalservicereportid ? _trs_technicalservicereportid_value.Id : Guid.Empty; }
            set { _trs_technicalservicereportid = true; _trs_technicalservicereportid_value = new EntityReference(_DL_trs_technicalservicereport.EntityName, value); }
        }
        ...
        public Guid Insert(IOrganizationService organizationService)
        {
            try
            {
                ...
                if (_trs_technicalservicereportid) { entity.Attributes["trs_technicalservicereportid"] = _trs_technicalservicereportid_value; };
