...
{
    public class DL_trs_contractpreventive
    {
        #region Dependencies
        ...
        #region Properties
        private string _classname = "DL_trs_contractpreventive";

        private string _entityname = "trs_contractpreventive";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Contract (Preventive)";
