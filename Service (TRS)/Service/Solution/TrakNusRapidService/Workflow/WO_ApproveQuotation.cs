// <copyright file="WO_ApproveQuotation.cs" company="Microsoft">
// Copyright (c) 2014 All Rights Reserved
// </copyright>
// <author>Microsoft</author>
// <date>12/12/2014 11:40:29 AM</date>
// <summary>Implements the WO_ApproveQuotation Workflow Activity.</summary>
namespace TrakNusRapidService.Workflow
{
    ...
    public sealed class WO_ApproveQuotation : CodeActivity
    {
        #region Depedencies
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            _BL_trs_quotation.ApproveQuotation_OnClick(organizationService, tracingService, id);
        }
    }
}