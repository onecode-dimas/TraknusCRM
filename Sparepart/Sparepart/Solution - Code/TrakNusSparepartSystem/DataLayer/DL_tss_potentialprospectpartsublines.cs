...
{
    public class DL_tss_potentialprospectpartsublines
    {
        #region Properties

        private string _classname = "DL_tss_potentialprospectpartsublines";

        private string _entityname = "tss_potentialprospectpartsublines";
