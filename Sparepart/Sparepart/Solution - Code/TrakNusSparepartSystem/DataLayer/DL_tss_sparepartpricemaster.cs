...
{
    public class DL_tss_sparepartpricemaster
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_tss_sparepartpricemaster";

        private string _entityname = "tss_sparepartpricemaster";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Sparepart Price Master";
