...
{
    public class DL_tss_sparepartsetup
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_tss_sparepartsetup";

        private string _entityname = "tss_sparepartsetup";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Spare Part Setup";
