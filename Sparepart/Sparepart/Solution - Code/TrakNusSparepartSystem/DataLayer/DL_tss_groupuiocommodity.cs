...
{
    public class DL_tss_groupuiocommodity
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_groupuiocommodity";

        private string _entityname = "tss_groupuiocommodity";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Group UIO Commodity";
