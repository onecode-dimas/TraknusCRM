...
{
    public class DL_tss_groupuiocommodityaccount
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_tss_groupuiocommodityaccount";

        private string _entityname = "tss_groupuiocommodityaccount";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Group UIO Commodity Account";
