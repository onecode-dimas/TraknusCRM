...
{
    public class DL_tss_pricelistpart
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_tss_pricelistpart";

        private string _entityname = "tss_pricelistpart";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Price List Part";
