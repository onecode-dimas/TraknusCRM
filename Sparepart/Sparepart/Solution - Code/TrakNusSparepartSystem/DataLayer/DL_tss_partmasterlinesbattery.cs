...
{
    public class DL_tss_partmasterlinesbattery
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_tss_partmasterlinesbattery";

        private string _entityname = "tss_partmasterlinesbattery";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Part Master Lines Battery Type";
