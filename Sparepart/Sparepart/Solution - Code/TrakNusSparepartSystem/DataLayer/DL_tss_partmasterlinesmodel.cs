...
{
    public class DL_tss_partmasterlinesmodel
    {
        #region Dependencies
        #endregion

        #region Properties
        private string _classname = "DL_tss_partmasterlinesmodel";

        private string _entityname = "tss_partmasterlinesmodel";
        public string EntityName
        {
            get { return _entityname; }
        }

        private string _displayname = "Part Master Lines Model";
