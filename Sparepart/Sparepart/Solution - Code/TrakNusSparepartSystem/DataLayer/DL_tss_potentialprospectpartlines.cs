...
{
    public class DL_tss_potentialprospectpartlines
    {
        #region Properties

        private string _classname = "DL_tss_potentialprospectpartlines";

        private string _entityname = "tss_potentialprospectpartlines";
