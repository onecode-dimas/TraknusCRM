...
{
    public class Calculate05 : ICalculate
    {
        ...
        public Calculate05(IOrganizationService orgService, Entity refEntity)
        {
        ...
        public void Calculate()
        {
            ...
            if (msLines.Count > 0)
            {
                var groupHeader = (from r in msLines.AsQueryable()
                                   ...
                                   select new
                                   {
                                       sumAmount = g.Sum(x =>
                                                           ...
                                                           * Convert.ToDecimal(((Int32)x.GetAttributeValue<AliasedValue>("mastermarketsizesubline.tss_qty").Value))),
                                       header = g.Key.groupByHeader
                                   }).ToList();
