...
namespace TrakNusSparepartSystemWcfService
{
    ...
    public interface IService
    {
        ...
        [OperationContract]
        WS_Response_CheckAROverdue CheckAROverdue(string token,string TransNumber, string CustomerCode,string BusinessTransType); 

    }

    [DataContract]
    public class WS_Response_CheckAROverdue
    {
        [DataMember]
