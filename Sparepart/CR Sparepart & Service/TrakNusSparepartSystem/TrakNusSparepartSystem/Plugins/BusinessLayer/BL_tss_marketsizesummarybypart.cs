...
{
     public class BL_tss_marketsizesummarybypart
    {
        #region Constants
        private const string _classname = "BL_tss_marketsizesummarybypart";
        private const string _entityname = "tss_marketsizesummarybyparttype";
        #endregion
