...
{
    public class DL_tss_totalpartconsumpmarketsize
    {

        #region Properties

        private string _classname = "DL_tss_totalpartconsumpmarketsize";

        private string _entityname = "tss_totalpartconsumpmarketsize";
