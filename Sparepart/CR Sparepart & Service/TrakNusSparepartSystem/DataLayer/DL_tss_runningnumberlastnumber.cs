...
namespace DataLayer
{
    public class DL_tss_runningnumberlastnumber
    {
        #region Dependencies
        ...
        private string _entityname = "tss_runningnumberlastnumber";
        ...
        public Guid tss_categorycode
        {
            ...
            set { _tss_categorycode = true; _tss_categorycode_value = new EntityReference(_DL_systemuser.EntityName, value); }
        }
        ...
        public Guid tss_branch
        {
            ...
            set { _tss_branch = true; _tss_branch_value = new EntityReference(_DL_systemuser.EntityName, value); }
        }
        #endregion
